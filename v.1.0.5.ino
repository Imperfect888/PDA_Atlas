...
struct Suit
  {
    ...
    unsigned short int Psycho = 62;
    unsigned short int Radiation = 20;
  };
...
unsigned short int RadiationTime = 0; //таймер удара радиации
//*************************************************************************************
...
void PDAVersion()
{
  ...
  tft.print("PDA   Atlas   v.1.0.5");//версия пда
...
void RadiationHits()
{
  ...
  {
    Player.Health = 0;
  }else if(Player.Radiation > 200000)
  {
    RadiationTime++;
    if(RadiationTime == 10)
    {
  ...
  }else if(Player.Radiation > 100000)
  {
    RadiationTime++;
    if(RadiationTime == 10)
    {
  ...
  }else if(Player.Radiation > 50000)
  {
    RadiationTime++;
    if(RadiationTime == 10)
    {
